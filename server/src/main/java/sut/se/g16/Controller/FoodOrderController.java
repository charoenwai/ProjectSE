...
public class FoodOrderController {
    ...
    public FoodOrderController(FoodOrderRepository foodOrderRepository, ListRepository listRepository,
    ...
    public Collection<TotalPriceFoodEntity> TotalPriceFoodEntity() {
        return totalPriceFoodRepository.findAll().stream().collect(Collectors.toList());
    }
    ...
    @GetMapping(path = "/foodorder/{hotel}/{room}/{list}")
    public Boolean newFoodOrder(@PathVariable String hotel, @PathVariable int room, @PathVariable String list) {
