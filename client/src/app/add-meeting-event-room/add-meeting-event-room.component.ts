...
export class AddMeetingEventRoomComponent implements OnInit {
  ...
  displayedColumns: string[] = ['position', 'roomname', 'roomprice', 'roomnumber', 'roomtype', 'hotel'];
...
export class DialogOverviewExampleDialog {
  ...
  /*getData(meetingEventRoomService,selectRowMeetingRoomId){
    meetingEventRoomService.getMeetingRoomStatusWhenClick(selectRowMeetingRoomId).subscribe(data => {
